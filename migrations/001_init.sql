...
ALTER TABLE raffles ADD COLUMN IF NOT EXISTS alerts_sent_count INTEGER NOT NULL DEFAULT 0;
...
ALTER TABLE admin_payout_wallets ADD COLUMN IF NOT EXISTS token_address TEXT;
